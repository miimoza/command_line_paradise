...
TOKEN = "Za6ND6xccvNyt7DeRVWnFWcyevSfSbKG2IYoyz0_BmQNdQf1K-1yNktaZtKXFq0D"
...
def input_title(data=None):
    ...
    if song == None:
        ...
        os.system("clear")
        print(f"{color.BOLD}{color.GREEN}{song.artist} - {song.title} {color.END}\n")
        print(song.lyrics)
...
def choose_song(data):
    ...
    print(f"{color.GREEN}{song.artist} - {song.title} - ({song.year})\n{color.END}")
    print(song.lyrics)
